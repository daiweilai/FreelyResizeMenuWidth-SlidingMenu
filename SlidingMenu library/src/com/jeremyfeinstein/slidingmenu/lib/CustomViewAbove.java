...
public class CustomViewAbove extends ViewGroup {
	...
	//fuck
	public void resetCurrentItem(int item, boolean smoothScroll) {
		resetCurrentItemInternal(item, smoothScroll);
	}
	...
	//fuck
	void resetCurrentItemInternal(int item, boolean smoothScroll) {
		resetCurrentItemInternal(item, smoothScroll, 0);
	}
	...
	//fuck 
	void resetCurrentItemInternal(int item, boolean smoothScroll, int velocity) {
		item = mViewBehind.getMenuPage(item);
